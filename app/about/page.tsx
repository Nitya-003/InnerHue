...
export default function AboutUs() {
    ...
    return (
        <main id="main" className="min-h-screen relative overflow-hidden text-foreground dark:text-white font-sans bg-gradient-to-br from-slate-50 via-white to-cyan-50 dark:from-[hsl(var(--page-gradient-from))] dark:via-[hsl(var(--page-gradient-via))] dark:to-[hsl(var(--page-gradient-to))]">
            <FloatingBackground />
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-20">
                ...
                >
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-xl text-muted-foreground dark:text-gray-300 max-w-2xl leading-relaxed">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="md:col-span-2 bg-card/75 dark:bg-white/10 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-2xl border border-border dark:border-white/10 cursor-default"
                    >
                        <h2 className="text-3xl font-bold text-foreground dark:text-white mb-6 flex items-center gap-3">
                            <motion.span
                        ...
                        <p className="text-lg text-muted-foreground dark:text-gray-200 leading-relaxed">
                    ...
                    <motion.div
                        ...
                        transition={{ type: 'spring', stiffness: 260, damping: 22 }}
                        className="bg-card/65 dark:bg-white/5 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-border dark:border-white/5 cursor-default"
                    >
                        <motion.div
                        ...
                        <h3 className="text-2xl font-bold text-foreground dark:text-white mb-4">How It Works</h3>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-foreground dark:text-white mb-4">For Everyone</h3>
                        <p className="text-muted-foreground dark:text-gray-300 leading-relaxed">
