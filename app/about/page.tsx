                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            ...
                            We believe that every emotion is valid and deserves to be heard. There is no &ldquo;right&rdquo; or &ldquo;wrong&rdquo; way to feel—only
                    ...
                    >
                        <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-purple-300 mb-6">
                            &ldquo;To feel is to be human.&rdquo;
                        </h3>
