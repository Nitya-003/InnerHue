    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/70 dark:bg-white/5 backdrop-blur-xl border border-border dark:border-white/10 text-sm text-muted-foreground dark:text-white/70">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground dark:text-white mb-6 leading-tight tracking-tight"
          style={{
        ...
        <motion.p
          variants={itemVariants}
          className="text-lg sm:text-xl md:text-2xl text-muted-foreground dark:text-white/60 max-w-2xl mx-auto mb-12 leading-relaxed font-light"
        >
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4 justify-center">
          <motion.button
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 sm:px-10 sm:py-5 
                       bg-card/80 dark:bg-white/10 backdrop-blur-2xl 
                       border border-border dark:border-white/20 
                       rounded-full
                       text-foreground dark:text-white text-lg sm:text-xl font-medium
                       shadow-[0_8px_32px_rgba(139,92,246,0.2)]
                       transition-all duration-500 ease-out
                       hover:bg-card dark:hover:bg-white/15 hover:border-border/90 dark:hover:border-white/30
        ...
        <motion.p
          variants={itemVariants}
          className="mt-8 text-sm text-muted-foreground dark:text-white/40"
        >
